  ...
  return (
    <div>
      <div className="min-h-screen h-auto bg-main bg-no-repeat bg-top bg-cover -z-10">
        <motion.div
          className="~px-4/8 pb-2 ~/md:~pt-22/32 lg:pt-28"
          initial={{ opacity: 0 }}
          animate={{ opacity: 1 }}
          transition={{ duration: 0.5 }}>
          <div className="relative text-white border-white border-2 rounded-[36px] max-w-5xl mx-auto before:backdrop-blur-md bg-[#737475]/50 flex flex-col gap-5 before:absolute before:top-0 before:left-0 before:right-0 before:bottom-0 before:inset-0 before:-z-10">
            <h1 className="text-white text-4xl ~/sm:~mt-5/10 sm:text-4xl w-full max-w-3xl self-center text-center font-bold rounded-md py-2">
