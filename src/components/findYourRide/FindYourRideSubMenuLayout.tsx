  ...
  return (
    <>
      <motion.div
        ...
        className="w-max min-w-max absolute right-[calc(100%+.5rem)] bg-white/30 backdrop-blur-md border border-white rounded-md text-white ~px-3/6 pt-2 pb-4 space-y-2 sm:w-auto">
