  ...
  return (
    <>
      <div className="w-full mr-auto bg-customCream rounded-3xl backdrop-blur-md text-black px-8 pt-2 pb-4 mt-2 lg:~lg:~px-4/8 lg:w-5/6">
        ...
        <div className="custom-scrollbar h-full max-h-[60vh] overflow-y-auto grid grid-cols-1 gap-3 pr-2 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 lg:max-h-[58vh]">
