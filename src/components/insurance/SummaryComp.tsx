  ...
  return (
    <div className="max-w-8xl mx-auto pb-12 ~px-4/12">
      <div className="bg-[rgba(246,244,241,1)] flex flex-col ~lg:~gap-5/10 w-full sm:w-2/3 mx-auto p-5 rounded-2xl">
        <div className="bg-insuranceSumary rounded-[4px] bg-customRed bg-contain flex h-full text-white p-4">
          <div className="w-full flex flex-col justify-center gap-3">
            ...
            <table className="text-white">
              ...
              <tbody>
                <tr>
                  <td className="py-2 text-center">Steering</td>
                  <td className="py-2 text-center">Manual</td>
                  <td className="py-2 text-center">Gasoline</td>
                  <td className="py-2 text-center">70L</td>
                </tr>
              </tbody>
            </table>
          </div>
